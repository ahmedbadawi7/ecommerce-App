...
class _SizeListState extends State<SizeList> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.separated(scrollDirection: Axis.horizontal,itemBuilder: (contex,index){
        return InkWell(
            onTap: (){
              setState(() {
          ...
          decoration: BoxDecoration(
            ...
            pinkClr.withOpacity(0.4):Colors.black:currentSelected == index?
          ...
          child: Text(sizeList[index],style:TextStyle(
            color: Get.isDarkMode?currentSelected == index ? Colors.white : Colors.white:
